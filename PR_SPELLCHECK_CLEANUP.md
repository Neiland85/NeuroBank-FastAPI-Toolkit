...
### Resumen
- Añadido `.codespell-ignore-words.txt` con términos en español y técnicos para reducir falsos positivos.
...
- Cobertura: términos en español comunes (e.g., "Administrativo", "componentes", "inicial", "cliente"), y términos técnicos ("selectin").
...
- Los términos en español generan falsos positivos en tools en inglés; se optó por un enfoque conservador con lista de exclusión.
...
- [ ] Activar codespell en CI (opcional)
